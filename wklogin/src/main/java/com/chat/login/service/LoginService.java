...
public interface LoginService {
    ...
    Observable<VerfiCodeResult> isRegister(@Body JSONObject jsonObject);
    ...
    @POST("user/email/registercode")
    Observable<VerfiCodeResult> emailRegisterCode(@Body JSONObject jsonObject);
    ...
    @POST("user/email/pwdforget")
    Observable<CommonResponse> emailPwdForget(@Body JSONObject jsonObject);
