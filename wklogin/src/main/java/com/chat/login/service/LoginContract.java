...
public class LoginContract {
    public interface LoginPersenter extends WKBasePresenter {
        ...
        void emailRegisterApp(String code, String email, String password, String inviteCode);

        void emailRegisterCode(String email);

        void emailForgetPwd(String email);

        void emailResetPwd(String email, String code, String pwd);

        void checkLoginAuth(String uid, String code);

        void resetPwd(String zooe, String phone, String code, String pwd);

        void isRegister(String zone, String phone, int accountType);
    }
    ...
    public interface LoginView extends WKBaseView {
        ...
        void setAccountRegistrationResult(int code, String msg, int exist);

        void setLoginFail(int code, String uid, String phone);

        void setSendCodeResult(int code, String msg);

        void setEmailRegisterCodeSuccess(int code, String msg);
