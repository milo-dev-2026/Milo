...
public class EasyConstraintLayout extends ConstraintLayout {
    ...
    public EasyConstraintLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EasyConstraintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
