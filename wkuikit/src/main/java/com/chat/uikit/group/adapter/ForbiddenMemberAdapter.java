 ...
 * 群禁言成员适配器
 */
public class ForbiddenMemberAdapter extends BaseQuickAdapter<WKChannelMember, BaseViewHolder> {

    public ForbiddenMemberAdapter(List<WKChannelMember> list) {
    ...
    protected void convert(@NonNull BaseViewHolder helper, WKChannelMember item) {
        ...
        // 显示禁言图标
        helper.setGone(R.id.bannedimg, false);
