...
public class UserModel extends WKBaseModel {
    ...
    public void updateUserSetting(String key, String value, final ICommonListener iCommonListener) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put(key, value);
        } catch (Exception e) {
    ...
    public void userQr(final IUserQr iUserQr) {
        request(createAuthService(UserService.class).userQr(), new IRequestResultListener<UserQr>() {
            @Override
    ...
    public void userQrUrl(final IUserQr iUserQr) {
