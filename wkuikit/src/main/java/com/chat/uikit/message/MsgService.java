...
public interface MsgService {
    ...
    @POST("message/pinned")
    Observable<CommonResponse> pinMsg(@Body JSONObject jsonObject);

    @POST("message/pinned/clear")
    Observable<CommonResponse> clearPinnedMsg(@Body JSONObject jsonObject);

    @POST("message/pinned/sync")
    Observable<JSONObject> syncPinnedMsg(@Body JSONObject jsonObject);

    @POST("message/list")
    Observable<JSONObject> getMessagesByIds(@Body JSONObject jsonObject);
}
