...
public class WKMsgItemViewManager {
    ...
    public void addChatItemViewProvider(int type, BaseItemProvider<WKUIChatMsgItemEntity> itemProvider) {
        ...
        try {
            ...
            // If the provider has no no-arg constructor (e.g. WKSystemProvider),
            // fall back to using the same instance for the pinned list.
            pinnedChatItemProviderList.put(type, itemProvider);
        }
