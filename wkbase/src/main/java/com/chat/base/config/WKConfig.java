...
public class WKConfig {
    ...
    public void setShortNo(String shortNo) {
        WKSharedPreferencesUtil.getInstance().putSP("wk_short_no", shortNo);
    }

    public String getShortNo() {
        return WKSharedPreferencesUtil.getInstance().getSP("wk_short_no");
    }
    ...
    public void setTrtcSdkAppId(int sdkAppId) {
        WKSharedPreferencesUtil.getInstance().putInt("trtc_sdk_app_id", sdkAppId);
    }

    public int getTrtcSdkAppId() {
        return WKSharedPreferencesUtil.getInstance().getInt("trtc_sdk_app_id");
    }

    public void setTrtcUserSig(String userSig) {
        WKSharedPreferencesUtil.getInstance().putSP("trtc_user_sig", userSig);
    }

    public String getTrtcUserSig() {
        return WKSharedPreferencesUtil.getInstance().getSP("trtc_user_sig");
    }
}
