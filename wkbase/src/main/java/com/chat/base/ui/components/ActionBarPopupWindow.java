...
//                            }
    ...
    public void startAnimation() {
        if (animationEnabled) {
            ...
            ActionBarPopupWindowLayout content = findPopupLayout(viewGroup);
            if (content == null) {
                return;
            }
            ...
            windowAnimatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    ActionBarPopupWindowLayout content = findPopupLayout((ViewGroup) getContentView());
    ...
    private static ActionBarPopupWindowLayout findPopupLayout(ViewGroup viewGroup) {
        ...
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            ...
            if (child instanceof ViewGroup) {
                ActionBarPopupWindowLayout found = findPopupLayout((ViewGroup) child);
