...
public class WMToolItalic extends WMToolItem {
    ...
    public List<View> getView(Context context) {
        ...
        button.setImageResource(R.drawable.ic_tool_italic);
    ...
    public void removeStyle(int start, int end) {
        ...
        for (StyleSpan span : spans) {
            if (span.getStyle() == Typeface.ITALIC) {
                ...
                if (spanStart < start) {
                    spannable.setSpan(new StyleSpan(Typeface.ITALIC), spanStart, start, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                if (spanEnd > end) {
                    spannable.setSpan(new StyleSpan(Typeface.ITALIC), end, spanEnd, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
                ...
                spannable.setSpan(new StyleSpan(Typeface.BOLD), Math.max(spanStart, start), Math.min(spanEnd, end), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
        setStyleState(false);
    }
